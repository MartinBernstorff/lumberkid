...
def add() -> None:
    ...
    issues = [
        *source.get_latest(cfg.in_progress_label),
        *source.assigned_to_me(cfg.in_progress_label),
    ]
    selected = IssueSelecter(cfg.issue_title_parser).select_issue_dialog(issues)
